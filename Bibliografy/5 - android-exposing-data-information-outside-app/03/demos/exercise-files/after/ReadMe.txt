...
The NoteActivity class utilizes these additional NoteKeeperProvider capabilities and there no longer needs to perform direct database interaction. 
  • The NoteActivity class performs all queries, inserts, updates, and deletes using Note Row URIs and the NoteKeeperProvider.
